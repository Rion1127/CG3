...
XMFLOAT3 ParticleManager2::eye = { 0, 0, -20.0f };
...
{
	// 3Dオブジェクトのインスタンスを生成
	ParticleManager2* object3d = new ParticleManager2();
	if (object3d == nullptr) {
		return nullptr;
	}
...
void ParticleManager2::Add(int life, XMFLOAT3 position, XMFLOAT3 velocity, XMFLOAT3 accel,
